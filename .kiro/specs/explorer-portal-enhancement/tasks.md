...
- [ ] 2. Portal navigation structure and layout
  - [-] 2.1 Create explorer_header.php partial
...
- [ ] 4. Integrate check-in into portal navigation
  - [~] 4.1 Refactor explorer_checkin.php to use shared portal layout
...
- [ ] 6. Contact Leaders page (explorer_contact.php)
  - [~] 6.1 Create explorer_contact.php
...
- [ ] 7. Emergencies page (explorer_emergencies.php)
  - [~] 7.1 Create explorer_emergencies.php
    - Validate token, include portal header/footer
...
- [ ] 8. Announcements display (explorer_announcements.php)
  - [~] 8.1 Create explorer_announcements.php — display logic
    - Validate token, include portal header/footer
  ...
  - [~] 8.2 Implement announcement acknowledgement POST handler
  ...
  - [ ]* 8.3 Write property test for announcement visibility (Property 3)
  ...
  - [ ]* 8.4 Write property test for badge count accuracy (Property 2)
  ...
  - [ ]* 8.5 Write property test for acknowledgement idempotence (Property 4)
  ...
  - [ ]* 8.6 Write property test for name validation (Property 5)
...
- [ ] 10. Leader announcement management (announcements_manage.php)
  - [~] 10.1 Create announcements_manage.php with session auth
  ...
  - [~] 10.2 Implement announcement creation POST handler
...
- [ ] 11. Team logs on team_links.php
  - [~] 11.1 Add team log creation form on team notes tab
  ...
  - [~] 11.2 Implement add_team_log POST handler
  ...
  - [~] 11.3 Display team logs on notes tab
  ...
  - [ ]* 11.4 Write property test for team log timestamp immutability (Property 7)
...
- [ ] 12. Person log timestamp immutability fix
  - [~] 12.1 Remove editable occurred_at field from person log forms
